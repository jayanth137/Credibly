...
import { Wallet, Play, Copy, User, CheckCircle, Check, Loader } from "lucide-react"
                    ...
                    <div className="flex flex-col md:flex-row justify-evenly ">
                        <div className="space-y-6">
                                ...
                                <div className="flex items-center justify-between ">
                                    ...
                                    <div className=" flex backdrop-blur-lg gap-4 bg-white/10 rounded-lg border border-white/20 shadow-lg p-2">
                                        <Avatar className="w-12 h-12">
                                            <AvatarImage src="https://thumbs.dreamstime.com/b/default-avatar-profile-icon-vector-social-media-user-photo-concept-285140929.jpg" alt="@shadcn" />
                            ...
                            <div className="flex w-full justify-center items-center space-x-2">
                                <Button className='bg-white text-black font-bold hover:bg-gray-400'>Claim Certificate {'(0.002 ETH)'}</Button>
                            </div>
