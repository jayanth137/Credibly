      ...
      <main className="flex-grow flex items-center justify-center p-8">
        <div className=" rounded-lg overflow-hidden w-9/12  h-[70vh] flex justify-center items-center mx-auto">
          <div className="flex flex-row h-full">
            <div className="  w-2/3  p-8 pr-20 text-white">
              ...
              <p className="mb-4 text-2xl font-bold italic">
                {'"'} Turn knowledge into revenue with Soulbound NFT based
                course certificates{'"'}
              </p>
              <p className="pr-4">
                At Credibily, you can easily upload your videos or playlists
                from YouTube. Once your content is completed, learners earn
                verifiable certificates, ensuring authenticity and security.
                Join a growing community of creators, where your contributions
                empower education and open new opportunities for learners around
                the globe.
              </p>
            </div>
            <div className=" w-1/3 backdrop-blur-lg bg-black/20  p-8 text-white flex flex-col justify-between">
              ...
              <p className="text-center mb-6 text-sm">
                "Unlock the Future of Learning & Creation. Upload, Earn, and
                Empower."
              </p>
              <Login />
