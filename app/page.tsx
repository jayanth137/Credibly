...
export default function Component() {
  ...
  return (
    <div className="h-[85vh] text-white overflow-hidden flex flex-col justify-center items-center mx-auto w-full">
      <main className="flex flex-row items-start py-20 justify-evenly lg:px-16 w-10/12 mx-auto z-10">
        <div
          className=" space-y-6 text-center -left mb-8  
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4 justify-start pt-4">
